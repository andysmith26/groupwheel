<script lang="ts">
  ...
  import logo from '$lib/assets/gw-logo-lg.png';
</script>
...
<div class="mx-auto max-w-3xl px-4 py-12">
  ...
  <section class="text-center">
    ...
    <div class="mt-8 flex justify-center gap-4">
      ...
      <a
        href="/activities"
        class="inline-block rounded-lg border border-gray-300 bg-white px-6 py-3 text-base font-semibold text-gray-700 shadow-sm hover:bg-gray-50 focus:ring-2 focus:ring-teal focus:ring-offset-2 focus:outline-none"
      >
        Go to Dashboard
      </a>
    </div>
  ...
  <section class="mt-16 grid gap-8 sm:grid-cols-2">
    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
      ...
      <p class="mt-2 text-sm text-gray-600">
        Students rank which groups they want to join. The algorithm optimizes so more kids get what
        they asked for.
      </p>
    </div>
    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
      ...
      <p class="mt-2 text-sm text-gray-600">
        All data stays in your browser. No accounts, no servers storing student info, no compliance
        headaches.
      </p>
    </div>
  </section>
