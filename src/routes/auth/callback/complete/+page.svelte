      ...
      <div>
        ...
        <div class="mt-6 space-y-3">
          ...
          >
            ...
            <span class="block text-xs font-normal opacity-80"> Sync local data to the cloud </span>
          </button>
          ...
          <button
            ...
            class="w-full rounded-md border border-red-300 bg-white px-4 py-2 text-sm font-medium text-red-700 hover:bg-red-50 focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:outline-none"
          >
            Discard local data
