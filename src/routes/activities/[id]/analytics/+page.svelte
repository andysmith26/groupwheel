    ...
    {:else}
      ...
      {#if totalSessions === 0}
        <div class="rounded-lg border-2 border-dashed border-gray-300 p-8 text-center">
          ...
          <h3 class="mt-4 text-lg font-medium text-gray-900">No saved sessions yet</h3>
          <p class="mt-2 text-sm text-gray-500">
            Analytics data is generated when you save sessions. Go to the workspace to create and
            save a grouping.
          </p>
          <button
            type="button"
        ...
        <div class="space-y-4">
          ...
          >
            <ObservationSummaryCard
              ...
              sentimentCounts={observationSummary?.sentimentCounts ?? {
                positive: 0,
                neutral: 0,
                negative: 0,
                unspecified: 0
