				...
				<div class="space-y-6">
					<div class="mx-auto max-w-md">
						...
						<input
							id="student-search"
							type="text"
							class="block w-full rounded-lg border border-gray-300 px-4 py-3 text-lg shadow-sm placeholder:text-gray-400 focus:border-teal focus:ring-2 focus:ring-teal"
								...
								{#each filteredAssignments as assignment (assignment.studentId)}
									<div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
										<div class="flex items-center justify-between">
											...
											<div class="rounded-full bg-teal/10 px-4 py-2">
												<p class="text-lg font-semibold text-teal">{assignment.groupName}</p>
											</div>
										</div>
									</div>
								{/each}
					...
					<div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
						{#each groupedAssignments as [groupName, members] (groupName)}
							<div class="rounded-lg border border-gray-200 bg-white shadow-sm">
								<div class="border-b border-gray-100 bg-teal/5 px-4 py-3">
