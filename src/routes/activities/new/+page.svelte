      ...
      {:else if activeStepType === 'students'}
        ...
        <div class="mb-6 rounded-xl border border-gray-200 bg-gray-50 p-4">
          ...
          <p class="mt-0.5 text-xs text-gray-500">
            Just need numbers? Enter a count and skip straight to grouping. You can add real names
            later.
          </p>
          <div class="mt-3 flex flex-wrap items-center gap-3">
            <label class="flex items-center gap-1.5 text-sm text-gray-700">
              ...
              <input
                ...
                max="200"
                inputmode="numeric"
                class="w-20 rounded-md border border-gray-300 px-2 py-1 text-center text-sm shadow-sm focus:border-teal focus:ring-1 focus:ring-teal focus:outline-none"
