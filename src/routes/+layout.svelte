  ...
  const navSections = [
    {
      ...
      items: [
        ...
        { href: '/programs/import', label: 'Roster Import' }
      ]
    },
    {
      title: 'Building now',
      ...
      items: [
        { href: '/pools', label: 'Pool Management' },
...
<div class="min-h-screen bg-gray-50">
  <header class="border-b bg-white shadow-sm">
    <div class="mx-auto flex max-w-6xl flex-col gap-3 px-4 py-3 md:flex-row md:items-center md:justify-between">
      <div>
        <p class="text-xs uppercase tracking-wide text-gray-500">Friend Hat</p>
        ...
        {#each navSections as section}
          <section class="space-y-2 rounded-xl border border-gray-200 bg-white/70 p-3 shadow-sm">
            <header class="space-y-1">
              <p class="text-xs font-semibold uppercase tracking-wide text-gray-500">{section.title}</p>
