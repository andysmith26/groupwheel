...
import type { CreatePoolFromRosterDataInput, CreatePoolFromRosterDataError } from './createPoolFromRosterData';
...
export type ImportRosterError = { type: 'PARSE_ERROR'; message: string } | CreatePoolFromRosterDataError;
