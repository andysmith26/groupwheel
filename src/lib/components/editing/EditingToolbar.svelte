...
<div
  class="flex flex-wrap items-center justify-between gap-3 rounded-md border border-gray-200 bg-white px-3 py-2"
>
    ...
    <div class="relative">
      ...
      {#if showExportMenu}
        ...
        >
          ...
          >
            Copy groupings
            <span class="block text-xs text-gray-500"> for pasting into a spreadsheet </span>
          </button>
