		...
		<div class="grid grid-cols-2 divide-x divide-gray-200">
			...
			<div class="p-4">
				...
				<div class="mb-4 space-y-1 text-sm">
					<div class="flex justify-between">
						...
						<span class="font-medium">{formatPercent(currentAnalytics.percentAssignedTopChoice)}</span>
					</div>
					<div class="flex justify-between">
					...
					<div class="flex justify-between">
						...
						<span class="font-medium">{formatRank(currentAnalytics.averagePreferenceRankAssigned)}</span>
					</div>
					{#if (currentAnalytics.studentsUnassignedToRequest ?? 0) > 0}
						<div class="flex justify-between">
							<span class="text-gray-600">No choice met</span>
							<span class="font-medium text-red-600">{currentAnalytics.studentsUnassignedToRequest}</span>
						</div>
					{/if}
				</div>
			...
			<div class="p-4">
				...
				<div class="mb-4 space-y-1 text-sm">
					<div class="flex justify-between">
						<span class="text-gray-600">Top choice</span>
						<span class="font-medium">{formatPercent(alternativeAnalytics.percentAssignedTopChoice)}</span>
					</div>
					<div class="flex justify-between">
						<span class="text-gray-600">Top 2</span>
						<span class="font-medium">{formatPercent(alternativeAnalytics.percentAssignedTop2)}</span>
					</div>
					<div class="flex justify-between">
						<span class="text-gray-600">Avg rank</span>
						<span class="font-medium">{formatRank(alternativeAnalytics.averagePreferenceRankAssigned)}</span>
					</div>
					{#if (alternativeAnalytics.studentsUnassignedToRequest ?? 0) > 0}
						<div class="flex justify-between">
							<span class="text-gray-600">No choice met</span>
							<span class="font-medium text-red-600">{alternativeAnalytics.studentsUnassignedToRequest}</span>
						</div>
					{/if}
				</div>
