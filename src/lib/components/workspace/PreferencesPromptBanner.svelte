  ...
  <div class="rounded-lg border border-purple-200 bg-purple-50 p-4">
    <div class="flex items-start justify-between gap-4">
      <div class="flex items-start gap-3">
        ...
        <div>
          <h3 class="text-sm font-medium text-purple-900">Have student preferences?</h3>
          <p class="mt-1 text-sm text-purple-700">
            Import partner choices or group preferences to help the algorithm make smarter
            placements when you regenerate.
          </p>
        </div>
      </div>
    ...
    <div class="mt-3 flex items-center gap-3">
      <button
        type="button"
        class="inline-flex items-center rounded-md bg-purple-600 px-3 py-1.5 text-sm font-medium text-white hover:bg-purple-700 focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:outline-none"
