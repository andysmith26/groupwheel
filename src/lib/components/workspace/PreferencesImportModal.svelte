    ...
    <div class="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-lg bg-white shadow-xl">
      ...
      <div class="space-y-6 p-6">
            ...
            {#if formatDetection}
              ...
              {#if tabData && formatDetection.format === 'matrix'}
                <div>
                  ...
                  <select
                    ...
                    onchange={(e) =>
                      (studentIdColumnIndex = parseInt((e.target as HTMLSelectElement).value))}
                  >
              ...
              <button
                ...
                disabled={isParsingSheet ||
                  (formatDetection.format === 'matrix' && studentIdColumnIndex < 0)}
              >
        ...
        {#if importSource === 'paste' || !hasSheetConnection}
          <div class="space-y-4">
            <div>
              <label for="preferences-paste" class="mb-2 block text-sm font-medium text-gray-700">
...
bob@school.edu,Science Club,Art Club,Music Club"
            ...
            {#if exampleCsv && groupNames.length > 0}
              <details class="text-sm">
                ...
                <pre class="mt-2 overflow-x-auto rounded bg-gray-100 p-3 text-xs">{exampleCsv}</pre>
              </details>
            {/if}
              ...
              {:else}
                <div class="rounded-lg border border-amber-200 bg-amber-50 p-3">
                  <p class="text-sm text-amber-700">
                    No valid preferences found. Check that student IDs match your roster and group
                    names match your groups.
                  </p>
                </div>
              {/if}
            {/if}
