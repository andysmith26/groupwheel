...
{:else}
  ...
  {#if hasPreviousSessions}
    <div class="mt-4 space-y-2 rounded-lg border border-gray-200 bg-white px-5 py-4 shadow-sm">
      ...
      {#if avoidRecentGroupmates}
        <div class="ml-7 flex items-center gap-2 text-sm text-gray-500">
          ...
          <select
            ...
            class="rounded border border-gray-300 px-1 py-0.5 text-sm text-gray-700 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none"
          >
  ...
  <button
    ...
    disabled={generating}
    class="mt-6 w-full rounded-lg bg-blue-600 px-6 py-3 text-base font-semibold text-white shadow-sm transition hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-60"
  >
    {#if generating}
  ...
  <div class="mt-6 text-center">
    <a href="/activities/{programId}" class="text-sm text-gray-400 hover:text-gray-600">
