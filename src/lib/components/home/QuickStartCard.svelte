...
<div class="rounded-xl border border-teal/30 bg-teal-light p-5">
	...
	<p class="mt-1 text-sm text-gray-600">
		See instant groups — no roster needed.
	</p>

	<div class="mt-4 flex items-end gap-3">
		<div class="flex-1">
			<label for="qs-students" class="block text-xs font-medium text-gray-700">
				Students
			</label>
			<input
				id="qs-students"
				...
				min="2"
				max="200"
				class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-teal focus:outline-none focus:ring-1 focus:ring-teal"
		...
		<div class="flex-1">
			<label for="qs-group-size" class="block text-xs font-medium text-gray-700">
				Per group
			</label>
			<input
				id="qs-group-size"
		...
		<button
			type="button"
			class="rounded-md bg-teal px-5 py-2 text-sm font-medium text-white shadow-sm hover:bg-teal-dark focus:outline-none focus:ring-2 focus:ring-teal focus:ring-offset-2 disabled:opacity-50"
