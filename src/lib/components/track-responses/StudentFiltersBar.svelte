  ...
  >
    <button
      ...
      class={`rounded-full px-3 py-1 transition-colors ${
        stateFilter === 'all' ? 'bg-gray-900 text-white' : 'text-gray-600 hover:bg-gray-50'
      }`}
    ...
    <button
      type="button"
      class={`rounded-full px-3 py-1 transition-colors ${
        stateFilter === 'submitted' ? 'bg-green-600 text-white' : 'text-gray-600 hover:bg-gray-50'
      }`}
    ...
    <button
      type="button"
      class={`rounded-full px-3 py-1 transition-colors ${
        stateFilter === 'ignored' ? 'bg-gray-700 text-white' : 'text-gray-600 hover:bg-gray-50'
      }`}
      onclick={() => onFilterSelect?.('ignored')}
      aria-pressed={stateFilter === 'ignored'}
    >
      Ignored <span class={stateFilter === 'ignored' ? 'text-white/70' : 'text-gray-400'}
        >{ignoredCount}</span
      >
    </button>
  </div>
