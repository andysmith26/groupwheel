...
<div class="space-y-4">
        <div>
                ...
                <p class="mt-1 text-sm text-gray-600">
                        Set your group shells now so we can size them when we auto-assign students.
                        You can tweak counts, min/max sizes, or paste a list of named groups with
                        capacities.
                </p>
        </div>
        ...
        <div class="grid gap-4 rounded-lg border border-gray-200 bg-white p-4 md:grid-cols-3">
                <div class="space-y-2">
                        ...
                        />
                        <p class="text-xs text-gray-500">We’ll distribute {studentCount} students across this many groups.</p>
                </div>

                <div class="space-y-2">
                        <label class="block text-sm font-medium text-gray-700" for="min-size">
                                Min size
                        </label>
                        <input
                                id="min-size"
                        ...
                        />
                        <p class="text-xs text-gray-500">Average size will stay above this when we auto-size groups.</p>
                </div>

                <div class="space-y-2">
                        <label class="block text-sm font-medium text-gray-700" for="max-size">
                                Max size
                        </label>
                        <input
                                id="max-size"
