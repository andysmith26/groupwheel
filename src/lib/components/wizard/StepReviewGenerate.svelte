...
<div class="space-y-6">
	...
	<div class="pt-2">
		<button
			type="button"
			class="w-full rounded-lg bg-coral px-6 py-4 text-lg font-medium text-white hover:bg-coral-dark disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
			disabled={!canSubmit}
			onclick={onSubmit}
		>
			{#if isSubmitting}
