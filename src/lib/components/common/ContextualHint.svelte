...
<div class="rounded-lg border border-teal-200 bg-teal-50/50 p-4" role="status" aria-live="polite">
  <div class="flex items-start gap-3">
    ...
    {#if dismissible && onDismiss}
      <button
        type="button"
        class="-mt-1 -mr-1 flex-shrink-0 rounded p-1 text-teal-500 hover:bg-teal-100 hover:text-teal-700 focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 focus:outline-none"
        onclick={onDismiss}
        aria-label="Dismiss"
      >
