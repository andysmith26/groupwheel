<script lang="ts">
  ...
  let { isOpen, templates, onClose, onSelectTemplate, isLoading = false }: Props = $props();
    ...
    <div class="mx-4 w-full max-w-lg rounded-lg bg-white shadow-xl">
      ...
      {:else}
        ...
        <div class="p-6">
          ...
          <p class="mt-1 text-sm text-gray-600">Select a saved template to use for your groups.</p>
        </div>
